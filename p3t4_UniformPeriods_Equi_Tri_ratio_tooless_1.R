...
write_xlsx(data,"D:/Special Issue/p3t4_UniformPeriods_Equi_Tri_ratio_tooless_1.xlsx")

#Calling library readxl
library(readxl)

p3t4_UniformPeriods_Equi_Tri_ratio_tooless_1=read_excel("D:/Special Issue/p3t4_UniformPeriods_Equi_Tri_ratio_tooless_1.xlsx")

min(p3t4_UniformPeriods_Equi_Tri_ratio_tooless_1$Efficiency) #Minimum efficiency
