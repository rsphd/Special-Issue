...
write_xlsx(data,"D:/Special Issue/p3t3_Uniform_Equi_Tri_ratio_toogreater_1.xlsx")

#Calling library readxl
library(readxl)

p3t3_Uniform_Equi_Tri_ratio_toogreater_1=read_excel("D:/Special Issue/p3t3_Uniform_Equi_Tri_ratio_toogreater_1.xlsx")

min(p3t3_Uniform_Equi_Tri_ratio_toogreater_1$Efficiency) #Minimum efficiency
