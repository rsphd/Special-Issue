...
write_xlsx(data,"D:/Special Issue/Gene Data Example_Equi_Tri_ratio_tooless_1.xlsx")

#Calling library readxl
library(readxl)

Example_Equi_Tri_ratio_tooless_1=read_excel("D:/Special Issue/Gene Data Example_Equi_Tri_ratio_tooless_1.xlsx")

min(Example_Equi_Tri_ratio_tooless_1$Efficiency) #Minimum efficiency
