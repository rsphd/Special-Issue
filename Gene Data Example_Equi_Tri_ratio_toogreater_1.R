#Efficiency of design used by Leaker et al. (2017) with p=3, t=3 and n=18 with sigma_1^2/sigma_2^2=100
library(MASS)
library(pracma)
...
write_xlsx(data,"D:/Special Issue/Gene Data Example_Equi_Tri_ratio_toogreater_1.xlsx")

#Calling library readxl
library(readxl)

Example_Equi_Tri_ratio_toogreater_1=read_excel("D:/Special Issue/Gene Data Example_Equi_Tri_ratio_toogreater_1.xlsx")

min(Example_Equi_Tri_ratio_toogreater_1$Efficiency) #Minimum efficiency


max(Example_Equi_Tri_ratio_toogreater_1$Efficiency) #Maximum efficiency
